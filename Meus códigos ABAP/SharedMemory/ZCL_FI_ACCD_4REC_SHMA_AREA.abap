class ZCL_FI_ACCD_4REC_SHMA_AREA definition
  public
...
public section.
  ...
  constants AREA_NAME type SHM_AREA_NAME value 'ZCL_FI_ACCD_4REC_SHMA_AREA' ##NO_TEXT.
  data ROOT type ref to ZCL_FI_ACC_DOC_4RE_CNT_SHM read-only .
  ...
  class-methods ATTACH_FOR_READ
    ...
    returning
      value(HANDLE) type ref to ZCL_FI_ACCD_4REC_SHMA_AREA
    raising
      CX_SHM_INCONSISTENT
  ...
  methods SET_ROOT
    importing
      !ROOT type ref to ZCL_FI_ACC_DOC_4RE_CNT_SHM
    raising
...
CLASS ZCL_FI_ACCD_4REC_SHMA_AREA IMPLEMENTATION.
